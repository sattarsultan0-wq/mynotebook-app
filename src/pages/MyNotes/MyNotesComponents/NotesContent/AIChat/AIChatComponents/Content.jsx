        ...
        <div className='chat__content'>
            ...
            <div className={preloader ? 'chat__preloader' : 'chat__preloader hidden'}>
                <div className='chat__preloader-container'>
                    ...
                    <h4>Твои данные — моя работа. Записывай мысли, отчеты или теорию. Я возьму на себя рутину: краткий пересказ, сложные расчеты и глубокий анализ. Сбрасывай первый материал — я выжму из него главное</h4>
                </div>
            </div>
        </div>
    )
